      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-black">PIXELS DIGITAL</h1>
              <p className="text-sm text-gray-600 font-light">Client Portal</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right hidden md:block">
                <p className="text-sm font-light text-black">{client?.name}</p>
                <p className="text-xs text-gray-600 font-light">{client?.company}</p>
              </div>
              <button
